package wangzhongqiu.spring.mybatis.interceptor;
...
import wangzhongqiu.spring.mybatis.dialect.Dialect;
import wangzhongqiu.spring.mybatis.utils.PropertiesHelper;
...
public class OffsetLimitInterceptor implements Interceptor {
    ...
    void processIntercept(final Object[] queryArgs) {
        // queryArgs = query(MappedStatement ms, Object parameter, RowBound
    ...
    private MappedStatement copyFromMappedStatement(MappedStatement ms, SqlSource newSqlSource) {
        ...
        builder.keyProperty((keyProperties != null && keyProperties.length > 0) ? keyProperties[0] : "");
